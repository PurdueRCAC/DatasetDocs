...
.. list-table:: Dataset Metadata
   ...
   * - Field
     - Value
   * - **Folder**
     - ``/datasets/geoai/ibm-esa-geospatial/TerraMesh``
   * - **Discipline**
     - GeoAI / Remote Sensing / Earth Science
   * - **DOI**
     - `10.48550/arXiv.2504.11172 <https://doi.org/10.48550/arXiv.2504.11172>`__
   * - **Link**
     - `Access Data <https://huggingface.co/datasets/ibm-esa-geospatial/TerraMesh>`__
   * - **Public**
     - ``True``
   * - **Publication Date**
     - 2025-09-05
